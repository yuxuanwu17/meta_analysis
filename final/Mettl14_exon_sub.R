...
## type3
asdiuh <- YGasd1[c(9,15,21,33,51,6,12,24,36,54),] #3,6
asdiuh <- as.data.frame(asdiuh)
asdiuh$gene <- c(2,3,4,6,9,1,2,4,6,9)

# x <- YGasd1[c(6,12,18,24,30,36,42,48,54,60,3,9,15,21,27,33,39,45,51,57),]

# res = rma(ci=ctrl_pos, di=ctrl_neg, ai=exp_pos, bi=exp_neg,data=x, measure="RR", method = "REML")
# baujat(res)
...
funnel(reg, xlab = "Correlation coefficient")
