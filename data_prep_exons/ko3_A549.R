...
mcols(human) <- Methylation_level[,c(17:18)]
...
Ctrl_peak <- read.csv("/home/kunqi/human_peakCalling/GSE55572/A549_Ctrl/Mod.csv")
...
M3KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE55572/A549_M3KO/Mod.csv")
...
saveRDS(storeMtx,"/home/yuxuan.wu/meta_analysis/exons_storeMtx/storeMtx_ko3_A549.rds")
View(storeMtx)
