...
## add the GSE110320 Mettle3 knockdown and control comparison 
mcols(human) <- Methylation_level[,c(57:58)]
...
Ctrl_peak <- read.csv("/home/kunqi/human_peakCalling/GSE110320/HepG2_Ctrl/Mod.csv")
...
M3KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE110320/HepG2_M3KO/Mod.csv")
...
saveRDS(storeMtx,"/home/yuxuan.wu/meta_analysis/exons_storeMtx/storeMtx_ko3_HepG2.rds")
View(storeMtx)