...
## add the GSE132306 Mettle3 knockdown and control comparison 
mcols(human) <- Methylation_level[,c(83:84)]
...
Ctrl_peak <- read.csv("/home/kunqi/human_peakCalling/GSE132306/EndoC-bH1_Ctrl/Mod.csv")
...
M3KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE132306/EndoC-bH1_M3KO/Mod.csv")
...
saveRDS(storeMtx,"/home/yuxuan.wu/meta_analysis/exons_storeMtx/storeMtx_ko3_EndoC-bH1.rds")
View(storeMtx)
