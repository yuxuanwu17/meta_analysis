...
mcols(human) <- Methylation_level[,c(29:30)]
...
M3KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE94808/GSC_M3KO/Mod.csv")
...
saveRDS(storeMtx,"/home/yuxuan.wu/meta_analysis/exons_storeMtx/storeMtx_ko3_GSC.rds")
View(storeMtx)
