...
## add the GSE93911 Mettle3 knockdown and control comparison 
mcols(human) <- Methylation_level[,c(97:98)]
...
Ctrl_peak <- read.csv("/home/kunqi/human_peakCalling/GSE93911/HEC-1-A_Ctrl/Mod.csv")
...
M3KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE93911/HEC-1-A_METTL3KD/Mod.csv")
...
saveRDS(storeMtx,"/home/yuxuan.wu/meta_analysis/exons_storeMtx/storeMtx_ko3_hec1.rds")
View(storeMtx)
