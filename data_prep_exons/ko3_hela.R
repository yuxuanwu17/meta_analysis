...
human_exon <- subsetByOverlaps(human,hk_exon) ## find the exon site that could be expressed methylation
...
saveRDS(storeMtx,"/home/yuxuan.wu/meta_analysis/exons_storeMtx/storeMtx_ko3_hela.rds")
