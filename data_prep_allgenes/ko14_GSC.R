...
## add the GSE94808 Mettle3 knockdown and control comparison 
mcols(human) <- Methylation_level[,c(29,31)]
...
Ctrl_peak <- read.csv("/home/kunqi/human_peakCalling/GSE94808/GSC_Ctrl/Mod.csv")
...
M14KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE94808/GSC_M14KO/Mod.csv")
