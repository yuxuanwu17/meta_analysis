...
mcols(human) <- Methylation_level[,c(8,10)]
...
M14KO_peak <- read.csv("/home/kunqi/human_peakCalling/GSE46705/HeLa_M14KO/Mod.csv")
...
length(which(c(background_motif$Ctrl-background_motif$M14KO)>0))
